@AbapCatalog.sqlViewName: '/DMO/IBOOKSU_U05'
...
define view /DMO/I_BookingSupplement_U05
  as select from /dmo/book_sup_05 as BookingSupplement

  association        to parent /DMO/I_Booking_U05  as _Booking         on  $projection.TravelID  = _Booking.TravelID
                                                                     and $projection.BookingID = _Booking.BookingID

  association [1..1] to /DMO/I_Supplement05     as _Product  on $projection.SupplementID = _Product.SupplementID
  association [1..*] to /DMO/I_Supplement05Text05 as _SupplementText on  $projection.SupplementID = _SupplementText.SupplementID
{
  ...
  key BookingSupplement.booking_supplement_id  as BookingSupplementID,
      ...
      @Consumption.valueHelpDefinition: [{entity: {name: '/DMO/I_SUPPLEMENT05', element: 'SupplementID' },
