@AbapCatalog.sqlViewName: '/DMO/ICONNE_R05'
...
define view /DMO/I_Connection_R05
  as select from /dmo/connecti_05 as Connection

  association [1..*] to /DMO/I_Flight_R05 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier05  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport05',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
