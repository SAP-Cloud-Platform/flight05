CLASS /dmo/cl_flight_amdp05 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS convert_currency IMPORTING VALUE(iv_amount)               TYPE /dmo/total_price05
                                                  VALUE(iv_currency_code_source) TYPE /dmo/currency_code05
                                                  VALUE(iv_currency_code_target) TYPE /dmo/currency_code05
                                                  VALUE(iv_exchange_rate_date)   TYPE d
                                        EXPORTING VALUE(ev_amount)               TYPE /dmo/total_price05.
ENDCLASS.



CLASS /dmo/cl_flight_amdp05 IMPLEMENTATION.
