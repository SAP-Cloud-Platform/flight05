@AbapCatalog.sqlViewName: '/DMO/CURRHLP05'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Help View for Currency Conversion'
define view /DMO/CURRENCY_HELPER05
  with parameters
    amount             : /dmo/total_price05,
    source_currency    : /dmo/currency_code05,
    target_currency    : /dmo/currency_code05,
    exchange_rate_date : /dmo/booking_date05

  as select from /dmo/agency05
