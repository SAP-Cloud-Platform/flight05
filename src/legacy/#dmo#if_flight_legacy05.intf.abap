...
INTERFACE /dmo/if_flight_legacy05
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL05
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel05     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING05
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking05    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_05
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_05 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT05
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight05 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id05.
  ...
  TYPES booking_id TYPE /dmo/booking_id05.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id05.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL05, /DMO/BOOKING05, /DMO/BOOK_SUP_05 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code05.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code05,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status05,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel05_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id05.
  INCLUDE TYPE /dmo/booking05_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id05.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id05.
  INCLUDE TYPE /dmo/book_sup_05_data.
