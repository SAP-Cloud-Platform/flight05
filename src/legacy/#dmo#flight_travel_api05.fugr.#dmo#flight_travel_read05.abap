...
"! @parameter es_travel             | Travel Data like /DMO/TRAVEL05 related to the importing Travel ID
"! @parameter et_booking            | Table of Bookings like /DMO/BOOKING05 related to the importing Travel ID
"! @parameter et_booking_supplement | Table of Booking Supplements like /DMO/BOOK_SUP_05 related to the importing Travel ID
"! @parameter et_messages           | Table of occurred messages
"!
FUNCTION /DMO/FLIGHT_TRAVEL_READ05.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
*"     REFERENCE(IV_TRAVEL_ID) TYPE  /DMO/TRAVEL_ID05
...
*"----------------------------------------------------------------------
  ...
  /dmo/cl_flight_legacy05=>get_instance( )->get_travel( EXPORTING iv_travel_id          = iv_travel_id
