...
*"        /DMO/IF_FLIGHT_LEGACY05=>TT_BOOKING_SUPPLEMENT_INX OPTIONAL
*"  EXPORTING
...
*"----------------------------------------------------------------------
  ...
  /dmo/cl_flight_legacy05=>get_instance( )->update_travel( EXPORTING is_travel              = is_travel
