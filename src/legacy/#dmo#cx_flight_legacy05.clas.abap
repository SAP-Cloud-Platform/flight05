CLASS /dmo/cx_flight_legacy05 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_05',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_05',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id05 OPTIONAL
        booking_id            TYPE /dmo/booking_id05 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id05 OPTIONAL
        agency_id             TYPE /dmo/agency_id05 OPTIONAL
        customer_id           TYPE /dmo/customer_id05 OPTIONAL
        carrier_id            TYPE /dmo/carrier05-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_05-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_05-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date05 OPTIONAL
        end_date              TYPE /dmo/end_date05 OPTIONAL
        booking_date          TYPE /dmo/booking_date05 OPTIONAL
        flight_date           TYPE /dmo/flight_date05 OPTIONAL
        status                TYPE /dmo/travel_status05 OPTIONAL
        currency_code         TYPE /dmo/currency_code05 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id05,
          mv_booking_id            TYPE /dmo/booking_id05,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id05,
          mv_agency_id             TYPE /dmo/agency_id05,
          mv_customer_id           TYPE /dmo/customer_id05,
          mv_carrier_id            TYPE /dmo/carrier05-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_05-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_05-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date05,
          mv_end_date              TYPE /dmo/end_date05,
          mv_booking_date          TYPE /dmo/booking_date05,
          mv_flight_date           TYPE /dmo/flight_date05,
          mv_status                TYPE /dmo/travel_status05,
          mv_currency_code         TYPE /dmo/currency_code05,
...
CLASS /dmo/cx_flight_legacy05 IMPLEMENTATION.
